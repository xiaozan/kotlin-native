...
internal class CEnumClassGenerator(
    ...
    private val cEnumClassCompanionGenerator = CEnumClassCompanionGenerator(irBuiltIns, symbolTable, typeTranslator)
    ...
    private fun provideIrClassForCEnum(descriptor: ClassDescriptor): IrClass =
            createClass(descriptor) { enumIrClass ->
                ...
                enumIrClass.addChild(cEnumClassCompanionGenerator.createEnumCompanionObject(enumIrClass))
                enumIrClass.addChild(cEnumVarClassGenerator.createEnumVarClass(enumIrClass))
            }
